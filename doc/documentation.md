...
with        | [_merkkijono_]    | Lista pilkulla erotetuista tietueisiin sisällytettävistä lisätiedoista
...
Organisaation ja kirjaston (library) välinen ero type-parametrin oletusarvossa. Organisaatioita haettaessa haetaan oletuksena kaikista organisaatiotietueita, mutta library-tyypillä suoditaan pois muut kuin kirjastojen toimipisteet ja kirjastoautot. Tarkoituksena on kätevöittää kirjastojen toimipisteiden hakemista pudottamalla pois yksi ylimääräinen parametri kyselyistä.

### Sallitut parametrit
Parametri    | Kuvaus
------------ | ------
with         | accessibility, extra, links, mail_address, persons, phone_numbers, pictures, services
city         | Kunnan id-tunniste
city.name    | Kunnan täsmällinen nimi. Haettaessa ruotsin kielellä käytetään ruotsalaista nimeä.
consortium   | Kirjastokimpan id-tunniste
...
region       | Maakunta-alueen id-tunniste
region.name  | Maakunta-alueen täsmällinen nimi. Riippuu valitusta kielestä.
service      | Organisaatioon liitetyn palvelun id-tunniste
service.name | Hakee organisaatiot, joihin on liitetty palvelu, jonka (ei-täsmällinen) nimi alkaa määrätyllä merkkijonolla

#### With-parametrin arvojen kuvaus
Osio          | Kuvaus
------------- | ------
...
Pasilan kirjaston tietue sisältäen aukioloajat syyskuulle 2015.
    `http://api.kirjastot.fi/v3/library/71895?with=schedules&schedules.start=2015-09-01&schedules.end=2015-09-30`
