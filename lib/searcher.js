...
let AbstractSearcher = function() {
  this.types = [];
  this.events = new events.EventEmitter;
};

AbstractSearcher.prototype = {
  searchOne: function(params) {
    let searcher = this;
    return new Promise(function(resolve, reject) {
      searcher.search(params).then(function(result) {
...
let Searcher = function(type, filters, sorting, sections) {
  AbstractSearcher.apply(this);

  this.compiler = new SearchParams(type, filters, sorting, sections);
  this.events = new events.EventEmitter;
};

Searcher.prototype = Object.create(AbstractSearcher.prototype, {
  search: {
    value: function(params) {
      ...
      return new Promise(function(resolve, reject) {
        ...
        database.elastic().search(query).then(function(response) {
          response.hits.type = compiler.type;
          let result = new Result(compiler.type, searcher.normalize(response.hits));
          searcher.events.emit("searcher.search", {params: params, result: result});
          resolve(result);
        }, function(error) {
...
PgSearcher.prototype = Object.create(AbstractSearcher.prototype, {
  search: {
    value: function(params) {
      let searcher = this;
      return new Promise(function(resolve, reject) {
  ...
  normalize: {
    value: function(type, result, count) {
      return {
        total: count[0].count,
        type: type,
...
exports.create = function(type) {
  switch (type) {
    case "organisation":
      ...
      ["services", "accessibility", "phone_numbers", "pictures", "links", "persons", "extra", "mail_address"]);
