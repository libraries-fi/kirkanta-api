...
const service_points = new Storage({
  ...
  filters: {
    ...
    q: (query, value) => {
      // NOTE: Use 'simple' mode since the keywords contain values from all available languages.
      query.andWhereRaw('organisations.api_keywords @@ plainto_tsquery(\'simple\', ?)', value);
    }
  },
  sorting: {
    id: 'id',
