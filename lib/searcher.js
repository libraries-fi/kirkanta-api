...
let organisations = searcher.addStorage(new elastic.Storage({
  type: "organisation",
...
searcher.addStorage(new elastic.Storage({
  type: "service",
  index: config.elastic.index,
  filters: {
    id: {
...
let schedules = searcher.addStorage(new elastic.Storage({
  type: "opening_time",
...
let consortiums = searcher.addStorage(new elastic.Storage({
  type: "consortium",
  index: config.elastic.index,
